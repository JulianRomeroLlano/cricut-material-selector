...
(function () {
  const STRINGS = {
    en: {
      ...
      sidebar_custom_count: function(n) { return n === 1 ? "1 custom material" : n + " custom materials"; },
      sidebar_export_btn:   "Export for Training",
    ...
    ja: {
      ...
      sidebar_all:    "すべての素材",
      sidebar_title:  "カテゴリ",
      sidebar_custom_count: function(n) { return n + "件のカスタム素材"; },
      sidebar_export_btn:   "トレーニング用にエクスポート",
