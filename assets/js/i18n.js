...
(function () {
  const STRINGS = {
    en: {
      ...
      form_material_name_hint:"Start typing to search 500+ known materials, or enter any name for AI prediction.",
      form_category:  "Material Type",
      form_category_hint: "Used as fallback if material name is unknown.",
    ...
    ja: {
      ...
      form_material_name_hint:"500種以上の素材名から検索、または任意の名前でAI予測。",
      form_category:  "素材タイプ",
      form_category_hint: "素材名が不明な場合のフォールバックとして使用します。",
      form_thickness: "厚さ",
